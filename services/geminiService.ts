...
export const performForensicAudit = async (input: AuditInput, industry: string, userTier: string = 'Free'): Promise<AuditReportData> => {
  ...
  if (!text) throw new Error("Audit generation failed");
