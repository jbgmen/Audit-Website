...
const CertificationInfo: React.FC = () => {
  return (
    <div className="max-w-5xl mx-auto space-y-12 md:space-y-24 py-12 md:py-20 px-4 md:px-6 animate-in fade-in slide-in-from-bottom-4 duration-700 w-full overflow-hidden">
      <div className="text-center space-y-4 px-4">
        <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-slate-900 italic tracking-tighter leading-tight">The Gold Standard in Verification</h2>
      ...
      <div className="bg-slate-900 rounded-[1.5rem] sm:rounded-[3rem] p-8 md:p-20 text-white relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="bg-white/5 border border-white/10 p-6 md:p-10 rounded-[1.5rem] md:rounded-3xl backdrop-blur-md">
            <p className="text-slate-200 italic mb-6 md:mb-10 text-sm md:text-lg leading-relaxed font-medium">"VelaCore Analytics has become our primary protocol for validating developer handovers. The certificate provides a neutral ground for quality."</p>
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 md:w-14 md:h-14 rounded-full bg-slate-800 border-2 border-white/10 shrink-0 shadow-inner overflow-hidden flex items-center justify-center p-2.5">
                <Logo type="square" inverse className="w-full h-full" />
              </div>
              <div>
